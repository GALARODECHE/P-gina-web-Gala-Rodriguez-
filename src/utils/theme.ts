...
export const bgThemeStyles: Record<BgThemeKey, BgStyleConfig> = {
  default: {
    name: 'Degradado Verde Claro a Melocotón Continuo',
    description: 'Degradado progresivo unificado desde verde claro en la parte superior hasta melocotón suave al final de la web',
    bodyBg: 'app-unified-gradient dark:bg-slate-950',
    cardBg: 'bg-white',
    accentSectionBg: 'bg-transparent',
    border: 'border-[#eedfd5]',
    previewBg: 'bg-gradient-to-b from-[#d6eee1] to-[#fff0e4] border border-[#d6eee1]',
  },
  'pure-white': {
    name: 'Melocotón Luminoso Puro',
    description: 'Fondo melocotón claro luminoso con tarjetas blancas',
    bodyBg: 'app-unified-gradient dark:bg-slate-950',
    cardBg: 'bg-white',
    accentSectionBg: 'bg-transparent',
    border: 'border-[#eddcd1]',
    previewBg: 'bg-[#fff8f1] border border-[#eddcd1]',
  },
  'warm-cream': {
    name: 'Melocotón Crema',
    description: 'Fondo melocotón cálido y luminoso con acentos salvia',
    bodyBg: 'app-unified-gradient dark:bg-slate-950',
    cardBg: 'bg-white',
    accentSectionBg: 'bg-transparent',
    border: 'border-[#eddcd1]',
  ...
  'soft-mint': {
    name: 'Salvia Marfil y Melocotón',
    description: 'Fondo verde salvia muy claro con toques melocotón',
    bodyBg: 'app-unified-gradient dark:bg-slate-950',
    cardBg: 'bg-white',
    accentSectionBg: 'bg-transparent',
    border: 'border-[#d8e6de]',
    previewBg: 'bg-[#f3f8f5] border border-[#d8e6de]',
  },
  'cool-sky': {
    name: 'Melocotón y Pizarra Suave',
    description: 'Fondo melocotón luminoso con contraste pizarra',
    bodyBg: 'app-unified-gradient dark:bg-slate-950',
    cardBg: 'bg-white',
    accentSectionBg: 'bg-transparent',
    border: 'border-[#eddcd1]',
